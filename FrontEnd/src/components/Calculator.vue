...
const renderChart = () => {
  ...
  const myChart = new VChart.init(chartDom);
...
const renderChart2 = () => {
  ...
  const myChart2 = new VChart.init(chartDom2);
    ...
    <el-row class="page-container">
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
        ...
        <el-card class="box-card">
          ...
          <div class="form-container">
            <el-select-v2 v-if="showInputFields" v-model="year" :options="years" placeholder="Pick a year"
              class="form-item" clearable />
            <el-select-v2 v-if="showInputFields" v-model="suburb" :options="suburbs" placeholder="Select the suburb"
              class="form-item" allow-create :reserve-keyword="false" filterable clearable />
            <el-input-number :min="1" v-if="showElecInput" v-model="elecUsage" placeholder="Electricity Usage(KWh)"
              class="form-item" />
            <el-input-number :min="1" v-if="showGasInput" v-model="gasUsage" placeholder="Gas Usage(m^3)"
              class="form-item" />
            <el-button v-if="showCalculateBtn" @click="calculate" type="success" round
              class="form-item">Calculate</el-button>
            <el-button v-if="showCompareBtn" @click="compareWithOthers" type="success" round
              class="form-item">Compare</el-button>
            <el-button style="margin-left: 0px;" v-if="showToCompareBtn" @click="toCompare" type="primary" round
              class="form-item">Compare</el-button>
            <el-button style="margin-left: 0px;" v-if="showBcakBtn" @click="goBack" type="primary" round
              class="form-item">Go Back</el-button>
          </div>
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
        <el-card class="box-card2">
          <div v-if="showCard1">
            <div>
              <el-row>
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8" class="carbon-result">
          ...
          <div v-if="showCard2">
            <div>
              <h2 class="compareTitle">Your Annual Carbon Emission VS {{ suburb }} residents average Annual Carbon
                Emission</h2>
              ...
              <div class="compareComment">
                <h3>Carbon Emission</h3>
                <p class="explanation-text"><strong>Your carbon </strong>Electricity: {{ newUserElec }} kg; Gas:
                  {{ newUserGas }} kg; Total: {{ newUserElec + newUserGas }} kg</p>
                <p class="explanation-text"><strong>{{ suburb }} carbon </strong>Electricity: {{ elec }} kg; Gas: {{ gas
                }}
                  kg; Total: {{ elec + gas }} kg</p>
              </div>
            </div>
          </div>
        </el-card>
...
.form-item {
  margin-bottom: 35px;
  /* distance between inputs and date piacker */
  width: 70%;
  text-align: left;
}
